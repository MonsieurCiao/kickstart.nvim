...
return {
  ...
  s(
    { trig = 'ddt', snippetType = 'autosnippet', priority = 1001, dscr = 'double dot accent (double Time derivative)', wordTrig = false },
    fmta('\\ddot{<>}', { i(1) }),
    { condition = in_mathzone }
  ),

  s({ trig = 'bar', snippetType = 'autosnippet', dscr = 'bar accent', wordTrig = false }, fmta('\\bar{<>}', { i(1) }), { condition = in_mathzone }),
  ...
  s(
    { trig = 'ff', snippetType = 'autosnippet', dscr = 'fraction operator', wordTrig = false },
    fmta('\\frac{<>}{<>}', { i(1), i(2) }),
    { condition = in_mathzone }
  ),

  s(
    { trig = 'tff', snippetType = 'autosnippet', priority = 1001, dscr = 'total derivative operator', wordTrig = false },
  ...
  s(
    { trig = 'ppff', snippetType = 'autosnippet', priority = 1002, dscr = 'partial partial fraction operator', wordTrig = false },
    fmta('\\frac{\\partial <>}{\\partial \\left(\\partial_{<>} <>\\right)}', { i(1), i(2), i(3) }),
    { condition = in_mathzone }
  ),

  s({ trig = 'sqrt', snippetType = 'autosnippet', dscr = 'sqrt snippet.', wordTrig = false }, fmta('\\sqrt{<>}', { i(1) }), { condition = in_mathzone }),

  s({ trig = 'grd', snippetType = 'autosnippet', dscr = 'Gradient', wordTrig = false }, fmta('\\vec{\\nabla}{<>}', { i(1) }), { condition = in_mathzone }),

  s(
    { trig = 'div', snippetType = 'autosnippet', dscr = 'Divergence', wordTrig = false },
    fmta('\\vec{\\nabla}\\cdot\\vec{<>}', { i(1) }),
    { condition = in_mathzone }
  ),

  s(
    { trig = 'rot', snippetType = 'autosnippet', dscr = 'Rotational', wordTrig = false },
    fmta('\\vec{\\nabla}\\times\\vec{<>}', { i(1) }),
    { condition = in_mathzone }
  ),

  s({ trig = 'lp', snippetType = 'autosnippet', dscr = 'Laplacian', wordTrig = false }, fmta('\\nabla^{2}{<>}', { i(1) }), { condition = in_mathzone }),

  s({ trig = 'bra', snippetType = 'autosnippet', dscr = 'Bra from bracket', wordTrig = false }, fmta('\\bra*{<>}', { i(1) }), { condition = in_mathzone }),

  s({ trig = 'ket', snippetType = 'autosnippet', dscr = 'Ket from bracket', wordTrig = false }, fmta('\\ket*{<>}', { i(1) }), { condition = in_mathzone }),

  s(
    { trig = 'brk', snippetType = 'autosnippet', dscr = 'Hilbert product', wordTrig = false },
    fmta('\\brk*{<>}{<>}', { i(1), i(2) }),
    { condition = in_mathzone }
  ),

  s(
    { trig = 'pd', snippetType = 'autosnippet', dscr = 'partial derivative down', wordTrig = false },
    fmta('\\partial_{<>}', { i(1) }),
    { condition = in_mathzone }
  ),

  s(
    { trig = 'pu', snippetType = 'autosnippet', dscr = 'partial derivative up', wordTrig = false },
    fmta('\\partial^{<>}', { i(1) }),
    { condition = in_mathzone }
  ),
  --Might we worth to delete the following to, since the advantage over typing pd is not substantial
  s({ trig = 'pt', dscr = 'Partial_time operator', wordTrig = false }, fmta('\\partial_{t}{<>}', { i(1) }), { condition = in_mathzone }),

  s({ trig = 'px', dscr = 'Partial_x operator', wordTrig = false }, fmta('\\partial_{x}{<>}', { i(1) }), { condition = in_mathzone }),

  s(
    { trig = 'du', snippetType = 'autosnippet', dscr = 'Exponent operator (superscript)', wordTrig = false },
    fmta('^{<>}', { i(1) }),
    { condition = in_mathzone }
  ),

  s({ trig = 'dn', snippetType = 'autosnippet', dscr = 'Exponent operator', wordTrig = false }, fmta('_{<>}', { i(1) }), { condition = in_mathzone }),

  s(
    { trig = 'over', snippetType = 'autosnippet', dscr = 'Exponent operator', wordTrig = false },
    fmta('\\overline{<>}', { i(1) }),
    { condition = in_mathzone }
  ),

  s(
    { trig = 'int', snippetType = 'autosnippet', dscr = 'Integral operator', wordTrig = false },
    fmta('\\int_{<>}^{<>} {<>} \\,d <>', { i(1), i(2), i(3), i(4) }),
    { condition = in_mathzone }
  ),

  s(
    { trig = 'iint', snippetType = 'autosnippet', priority = 1001, dscr = 'Double Integral operator', wordTrig = false },
    fmta('\\iint_{<>} {<>} \\,d <> \\,d <>', { i(1), i(2), i(3), i(4) }),
    { condition = in_mathzone }
  ),

  s(
    { trig = 'bint', snippetType = 'autosnippet', priority = 1001, dscr = 'Bound integral. ', wordTrig = false },
    fmta('\\oint_{<>} {<>} \\,d <>', { i(1), i(2), i(3) }),
    { condition = in_mathzone }
  ),

  s(
    { trig = 'bbint', snippetType = 'autosnippet', priority = 1002, dscr = 'Bound double integral. ', wordTrig = false },
    fmta('\\varoiint_{<>} {<>} \\,d <> \\,d <>', { i(1), i(2), i(3), i(4) }),
    { condition = in_mathzone }
  ),

  s(
    { trig = 'fint', snippetType = 'autosnippet', priority = 1001, dscr = 'Integral operator from -inf to inf (full integral)', wordTrig = false },
    fmta('\\int_{-\\infty}^{\\infty} {<>} \\,d <>', { i(1), i(2) }),
    { condition = in_mathzone }
  ),

  s(
    { trig = 'x-x', snippetType = 'autosnippet', dscr = 'A shortcut that places an expression for the distance between two vectors. ', wordTrig = false },
    fmta("\\vb*{\\vec{x} - \\vec{x}\\text{ } '} <>", { i(1) }),
    { condition = in_mathzone }
  ),

  s(
    { trig = 'sum', snippetType = 'autosnippet', dscr = 'Sum operator', wordTrig = false },
    fmta('\\sum_{<>}^{<>} {<>} ', { i(1), i(2), i(3) }),
    { condition = in_mathzone }
  ),

  s(
    { trig = 'ee', snippetType = 'autosnippet', dscr = 'exponential function', wordTrig = false },
    fmta('e^{<>} <>', { i(1), i(0) }),
    { condition = in_mathzone }
  ),

  s(
    { trig = 'ind', snippetType = 'autosnippet', dscr = 'exponential indices', wordTrig = false },
    fmta('\\indices{<>}<>', { i(1), i(0) }),
    { condition = in_mathzone }
  ),

  s(
    { trig = 'lim', snippetType = 'autosnippet', dscr = 'limit operator', wordTrig = false },
    fmta('\\lim_{<> \\to <>} <> <>', { i(1), i(2), i(3), i(0) }),
    { condition = in_mathzone }
  ),
  ...
  s(
    { trig = 'ae', snippetType = 'autosnippet', priority = 1001, dscr = "Adds '&\\' for use with align. Think 'Ampersand End' as the hint.", wordTrig = false },
    {
      t '&\\\\',
    },
    { condition = in_mathzone }
  ...
  s(
    { trig = 'mfc', snippetType = 'autosnippet', dscr = 'Math font-> caligraphy', wordTrig = false },
    fmta('\\mathcal{<>}', { i(1) }),
    { condition = in_mathzone }
  ),

  s({ trig = 'mfb', snippetType = 'autosnippet', dscr = 'Math font-> Bold', wordTrig = false }, fmta('\\mathbb{<>}', { i(1) }), { condition = in_mathzone }),

  s(
    { trig = 'mff', snippetType = 'autosnippet', priority = 1001, dscr = 'Math font-> frak', wordTrig = false },
    fmta('\\mathfrak{<>}', { i(1) }),
    { condition = in_mathzone }
  ),
  ...
  s(
    { trig = 'sin', snippetType = 'autosnippet', priority = 1000, dscr = 'sin function', wordTrig = false },
    fmta('\\sin<> ', { i(1) }),
    { condition = in_mathzone }
  ),

  s(
    { trig = 'cos', snippetType = 'autosnippet', priority = 1000, dscr = 'cos function', wordTrig = false },
    fmta('\\cos<> ', { i(1) }),
    { condition = in_mathzone }
  ),

  s(
    { trig = 'tan', snippetType = 'autosnippet', priority = 1000, dscr = 'tan function', wordTrig = false },
    fmta('\\tan<> ', { i(1) }),
    { condition = in_mathzone }
  ),

  s(
    { trig = 'hsin', snippetType = 'autosnippet', priority = 1001, dscr = 'hyperbolic sin function', wordTrig = false },
    fmta('\\sinh<> ', { i(1) }),
    { condition = in_mathzone }
  ),

  s(
    { trig = 'hcos', snippetType = 'autosnippet', priority = 1001, dscr = 'hyperbolic cos function', wordTrig = false },
    fmta('\\cosh<> ', { i(1) }),
    { condition = in_mathzone }
  ),

  s(
    { trig = 'htan', snippetType = 'autosnippet', priority = 1001, dscr = 'hyperbolic tan function', wordTrig = false },
    fmta('\\tanh<> ', { i(1) }),
    { condition = in_mathzone }
  ),

  s(
    { trig = 'asin', snippetType = 'autosnippet', priority = 1001, dscr = 'arcsin function', wordTrig = false },
    fmta('\\arcsin<> ', { i(1) }),
    { condition = in_mathzone }
  ),

  s(
    { trig = 'acos', snippetType = 'autosnippet', priority = 1001, dscr = 'arccos function', wordTrig = false },
    fmta('\\arccos<> ', { i(1) }),
    { condition = in_mathzone }
  ),

  s(
    { trig = 'atan', snippetType = 'autosnippet', priority = 1001, dscr = 'arctan function', wordTrig = false },
    fmta('\\arctan<> ', { i(1) }),
    { condition = in_mathzone }
  ),

  s({ trig = 'log', snippetType = 'autosnippet', priority = 1000, dscr = 'log function', wordTrig = false }, t '\\log', { condition = in_mathzone }),

  s(
    { trig = 'ln', snippetType = 'autosnippet', priority = 1001, dscr = 'natural log function', wordTrig = false },
    fmta('\\ln \\left( <> \\right) ', { i(1) }),
    { condition = in_mathzone }
  ),
}
